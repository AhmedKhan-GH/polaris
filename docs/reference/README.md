...
- [`security-practices.md`](security-practices.md) — generic web-security how-to: the Server-Actions-vs-API-Routes decision guide, per-change checklists, and pre-deploy list (the Polaris-specific model is [`SECURITY-HANDBOOK`](../../SECURITY.md)).
