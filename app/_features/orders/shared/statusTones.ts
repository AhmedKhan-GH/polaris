...
export const STATUS_BUTTON_TONES: Record<OrderStatus, string> = {
  ...
  discarded: 'border-zinc-500/40 bg-zinc-950/80 text-red-300 hover:bg-red-500/10',
  ...
  archived:  'border-emerald-500/40 bg-emerald-950/65 text-emerald-300 hover:bg-emerald-500/20',
}
